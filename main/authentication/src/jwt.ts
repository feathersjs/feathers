...
import { Params } from '../../feathers/src/index.ts';
import { createDebug } from '../../commons/src/index.ts';
// @ts-ignore
import lt from 'long-timeout';
import { IncomingMessage } from 'http';

import { AuthenticationBaseStrategy } from './strategy.ts';
import { AuthenticationRequest, AuthenticationResult, ConnectionEvent } from './core.ts';
