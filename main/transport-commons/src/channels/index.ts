import { Application, FeathersService, getServiceOptions } from '../../../feathers/src/index.ts';
import { createDebug } from '../../../commons/src/index.ts';
import { compact, flattenDeep, noop } from 'https://deno.land/x/lodash@4.17.19/lodash.js';
import { Channel, RealTimeConnection } from './channel/base.ts';
import { CombinedChannel } from './channel/combined.ts';
import { channelMixin, publishMixin, keys, PublishMixin, Event, Publisher } from './mixins.ts';
