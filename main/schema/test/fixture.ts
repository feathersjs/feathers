...
import { memory, MemoryService } from "../../memory/mod.ts";
import { GeneralError } from "../../errors/mod.ts";
...
import { AdapterParams } from "../../adapter-commons/mod.ts";
...
app
  .service("users")
  .hooks([
    resolveDispatch(userExternalResolver),
    resolveResult(userResolver, secondUserResolver),
  ]);
