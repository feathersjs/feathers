import { FromSchema } from "https://deno.land/x/json_schema_to_ts@v2.5.5/index.d.ts";
...
export type AuthenticationConfiguration = FromSchema<
...
export type DefaultAppConfiguration = FromSchema<
  typeof defaultAppConfiguration
>;
