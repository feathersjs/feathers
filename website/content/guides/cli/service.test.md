...
Services can be tested by using the [application](./app) object through Feathers standard APIs:
...
::note[tip]
If you want to test the full authentication and external access flow the [client.test](./client.test) can be used.
::
