import { Application, FeathersService, RealTimeConnection } from '../declarations.js'
import { getServiceOptions } from '../service.js'
import { createDebug } from '../commons.js'
import { Channel } from './channel/base.js'
import { CombinedChannel } from './channel/combined.js'
import { channelMixin, publishMixin, keys, PublishMixin, Event, Publisher } from './mixins.js'
import EventEmitter from 'events'

const debug = createDebug('@feathersjs/transport-commons/channels')
const { CHANNELS } = keys

// Custom implementation of flattenDeep
